    ...
    <div className="relative overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-900/80 p-8 md:p-12 text-center">
      ...
      <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-3">
        <a
          ...
          className="group inline-flex items-center justify-center w-full sm:w-auto px-7 py-3 rounded-full bg-emerald-500 hover:bg-emerald-400 text-emerald-950 font-bold text-base transition"
        >
          Get Started
          ...
          <React.Fragment key={r.label}>
            ...
            <a
              ...
              {...(r.external
                ...
                : {})}
              className="text-gray-200 hover:text-emerald-300 transition font-medium"
            >
              {r.label}
            </a>
          </React.Fragment>
