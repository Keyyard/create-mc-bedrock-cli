...
const FeaturesSection: React.FC = () => (
  <section className="w-full max-w-6xl mx-auto px-4 py-16 md:py-24">
    <div className="text-center mb-12">
      ...
      <p className="mt-3 text-base text-zinc-300 max-w-2xl mx-auto">
    ...
    <div className="space-y-10 md:space-y-16">
      {features.map((f, i) => (
        ...
        >
          <div>
            <h3 className="font-header text-xl md:text-2xl font-bold text-white">
              {f.title}
            </h3>
          ...
          <div className="relative rounded-lg border border-zinc-800 bg-zinc-900 overflow-hidden">
            <div className="flex items-center gap-1.5 px-4 py-2 border-b border-zinc-800 bg-zinc-950/60">
              ...
              <span className="ml-auto text-[10px] font-code uppercase tracking-wider text-zinc-300">
                {f.language}
              </span>
            </div>
