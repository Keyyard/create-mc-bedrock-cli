...
const Header: React.FC = () => (
  <header
    id="start"
    className="relative flex flex-col items-center text-center w-full overflow-hidden pt-28 pb-16 md:pt-36 md:pb-24"
  >
    {/* Dark hero base */}
    <div
      className="absolute inset-0 -z-20 pointer-events-none bg-zinc-950"
      aria-hidden
    />
    <div
    ...
    <div className="relative flex flex-col items-center w-full max-w-4xl px-4">
      <h1 className="mt-8 font-header text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tight text-white leading-[1.05]">
        Skip the lazy part,
        <br />
        work hard and{" "}
      ...
      <div className="mt-8 flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
        <a
          ...
          className="inline-flex items-center justify-center w-full sm:w-auto px-7 py-3 rounded-full bg-emerald-500 hover:bg-emerald-500/80 text-emerald-950 font-bold text-base transition"
        >
          Get Started
        </a>
        <a
